...
namespace GestionReservaAppMVC.GestionReservaWS {
    ...
    public interface IGestionReservaService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGestionReservaService/actualizarReserva", ReplyAction="http://tempuri.org/IGestionReservaService/actualizarReservaResponse")]
        [System.ServiceModel.FaultContractAttribute(typeof(GestionReservaAppMVC.GestionReservaWS.ValidationException), Action="http://tempuri.org/IGestionReservaService/actualizarReservaValidationExceptionFau" +
            "lt", Name="ValidationException", Namespace="http://schemas.datacontract.org/2004/07/EspacioDeportivoServices.Excepcion")]
    ...
    public partial class GestionReservaServiceClient : System.ServiceModel.ClientBase<GestionReservaAppMVC.GestionReservaWS.IGestionReservaService>, GestionReservaAppMVC.GestionReservaWS.IGestionReservaService {
        ...
        public string actualizarReserva(int codigo, int codigoEspacio, string dia, int cantHoras, string fechaInicio, string fechaFin, string estado) {
            return base.Channel.actualizarReserva(codigo, codigoEspacio, dia, cantHoras, fechaInicio, fechaFin, estado);
        }
